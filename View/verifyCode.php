          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <div id="message">
                    <div class="alert alert-warning">Mã xác thực đã được gửi qua email: <span style="color:#1cc88a;"><?php echo $email; ?></span></div>
                </div>
                <div id="hidden" style="display: none;"></div>
                <div id="data">
                    
                    <form id="myverifyform" action="index.php?action=forgetpassword&act=verify_action" class="mx-1 mx-md-4" method="post">
                        <div class="d-flex flex-row align-items-center mb-4">
                            <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                            <div class="form-outline flex-fill mb-0">
                            <label class="form-label" for="verifycode">Verify Code</label>
                            <input type="number" name="txtverifycode" id="verifycode" class="form-control" />
                            <input type="hidden" name="txtemail" value="<?php echo $email;?>"/>
                            <span class="error" id="verifycode_err"></span>
                            </div>
                        </div>

                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button type="submit" id="verifysubmitbtn" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Verify</button>
      ...
      if (!checkemail()) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            let newForm = `<form id="myverifyform" action="index.php?action=forgetpassword&act=verify_action" class="mx-1 mx-md-4" method="post">
                              <div class="d-flex flex-row align-items-center mb-4">
                                  <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                  <div class="form-outline flex-fill mb-0">
                                  <label class="form-label" for="verifycode">Verify Code</label>
